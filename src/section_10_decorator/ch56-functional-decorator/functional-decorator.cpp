...
int main() {
    printTitle();
    Logger([]() { std::cout << "Hello, world!" << std::endl; }, "Hello, world!")();

    // makeLogger needed before C++17 because CTAD (class template argument deduction) is not
    // supported
    auto log = makeLogger([]() { std::cout << "Hello, world 2!" << std::endl; }, "HelloFun2");
    log();

    // CTAD (class template argument deduction) is supported since C++17
    Logger2 log2([]() { std::cout << "Hello, world 3!" << std::endl; }, "HelloFun3");
    log2();
