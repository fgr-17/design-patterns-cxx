...
void process(Rectangle* r) {
    ...
    std::cout << "expected area = " << (w * magicNumber) << ", got: " << r->area() << std::endl;
}
...
int main() {
    ...
    Square sq{side3};
    process(&sq);
    // the function "process" does not aligns with Liksov subs principle as the argument of
    // process() of type Rectangle cannot be substituted by a child class
